...
subtitle: 'Homework 4: Data Visualization and Modeling in R'
output:
...
```{r}
kickedCars <- read.csv("/Users/nidhi/Desktop/Nido Drive/ITM 818 Data Mgmt and Vis/Homework/HW4/kickedCars.csv", header=TRUE)
View(kickedCars)
cars = kickedCars
```
